...
This repository is a DSSI-focused deployment fork of [`tantaihaha4487/discord-vector-rag`](https://github.com/tantaihaha4487/discord-vector-rag).

It is a Discord.js v14 bot that answers questions from local knowledge files when mentioned. It supports text, PDF, and image knowledge files, stores embeddings in Qdrant, uses Ollama for local embeddings by default, and can answer with any configured OpenAI-compatible chat provider.
...
### 2. Configure Secrets and Discord IDs
...
AI_PROVIDER_OPENROUTER_API_KEY=YOUR_API_KEY
```
...
src/events/interactionCreate/ Button and modal interaction handlers
